        ...
        ?>
            <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <span class="badge bg-danger"><?=getUserName($db,$post['user_id'])?></span>
...
<!-- 
                  ...
                  <button type="button" class="btn btn-primary" ><a href="addblog.php"  style="text-decoration:none; color:white;">Write Your Own Blog</a></button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $pquery="SELECT * FROM posts WHERE user_id={$post['user_id']} ORDER BY id DESC";
