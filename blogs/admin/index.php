...
<head>
  ...
  <title>Don't Trash It Blogs Admin Panel</title>
...
<tr>
                    <td><?=$count?></td>
                    <td><?=$post['title']?></td>
                    <td><?=getUserName($db,$post['user_id'])?></td>
  ...
  <div class="col-lg-12"  style="margin-top: 60px;">
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <div class="form">
                      <form action="./includes/addpost_admin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group">
                      <div class="col-sm-12">
