...
<body>
  ...
  <div id="home">
    <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        <img src="images_home/img1.jpeg" style="width:100%; height: 723px;">
      ...
      <div class="mySlides fade">
        <img src="images_home/img2.jpeg" style="width:100%; height: 723px;">
        <div class="text">Reuse it or refuse if, Beat plastic pollution ~ Saurav Banerjee</div>
      </div>
      
      <div class="mySlides fade">
        <img src="images_home/img3.jpeg" style="width:100%; height: 723px;">
  ...
  <div id="facts">
       <div class="container1">
         <h1>Did you know?</h1>
         <ul >
          <li id="fact1" onload="fact_fetch()"><img src="images_home/img4.png">Some tea bags release microplastic in your drinks.</li>
          <li id="fact2" onload="fact_fetch()"><img src="images_home/img5.png"> WorldEconomicForum has predicted that By 2050 there will be more plastic than fish in the ocean.</li>
          <li id="fact3" onload="fact_fetch()"><img src="images_home/img6.png">Around the world, nearly a million plastic beverage bottles are sold every minute.</li>
          <li id="fact4" onload="fact_fetch()"><img src="images_home/img7.png"> 69k pounds of plastic enter the ocean every 2 and a half minutes.</li>
         </ul>
       </div>
  </div>

  <!-- Sticky button for Footprint Calculator and FAQs -->
  <div class=icons>
    <a href="footprint.php" class="footprint"><i class="fa-solid fa-shoe-prints"></i>Footprint Calculator</a>
    <a href="qna.php" class="FAQS"><i class="fa-solid fa-circle-question"></i>Plastic FAQs</a>
  </div>
  <!--daily challenges-->
<div id="challenges">
  ...
  <div class="challenge">
  <div class="flip-card" id="challenge">
  ...
  <div id="contact">
    <div class="left">
      ...
      <div class = "socials">
        <a href="#"><img src="images_home/instagram.png" ></a>
          <a href="#"><img src="images_home/twitter.png" ></a>
          <a href="#"><img src="images_home/linkedin.png" ></a>
        </div>
    </div>
    <div class="right">
      <h1>Contact.</h1>
